...
# Clave secreta y algoritmo (usa los mismos que en tu login)
SECRET_KEY = "tu_clave_secreta_segura"   # ⚠️ cámbiala en producción
ALGORITHM = "HS256"
...
def obtener_usuario_actual(
    ...
    usuario = db.get(Usuario, int(usuario_id))   # ✅ forma moderna en SQLAlchemy 2.0
    if usuario is None:
