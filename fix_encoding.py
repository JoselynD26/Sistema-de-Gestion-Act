# Script to create email_service.py with correct encoding
content = """# Email service using Resend
import random
import string
...
print("✅ email_service.py created successfully with UTF-8 encoding")
